...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    dx3, grads['W3'], grads['b3'] = affine_backward(dscores, L3_cache)
    grads['W3'] += self.reg * W3
    dx2, grads['W2'], grads['b2'] = affine_relu_backward(dx3, L2_cache)
    grads['W2'] += self.reg * W2
    dx1, grads['W1'], grads['b1'] = conv_relu_pool_backward(dx2, L1_cache)
